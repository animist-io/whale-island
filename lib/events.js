 ...
 * @return {Object}       Updated 'lastBlock' document 
 */
 ...
 */
const addProximityEvent = exports.addProximityEvent = function( event ){
 ...
 */
const startProximityContractFilter = exports.startProximityContractFilter = function( cb ){
 ...
 * @param  {Function} cb (Optional) Callback to execute when an event is logged and saved in the DB
 */
const startBroadcastContractFilter = exports.startBroadcastContractFilter = function( cb ){
