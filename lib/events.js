 ...
 */
const startMessagePublicationRequestsFilter = function( eventsContractAddress, successCb, errorCb ){
    ...
    getLastSavedBlock().then( last => {
        ...
        messageFilter.watch((err, event) => {
            ...
            } else errorCb(errors.validationError);
        })
    }) 
}
