module.exports = {
    ...
    "eventsABI" : [{"constant":false,"inputs":[{"name":"node","type":"address"},{"name":"channel","type":"string"},{"name":"message","type":"string"},{"name":"duration","type":"uint32"}],"name":"requestBroadcast","outputs":[],"type":"function"},{"constant":false,"inputs":[{"name":"node","type":"address"},{"name":"account","type":"address"},{"name":"contractAddress","type":"address"}],"name":"requestProximityDetection","outputs":[],"type":"function"},{"anonymous":false,"inputs":[{"indexed":true,"name":"node","type":"address"},{"indexed":true,"name":"account","type":"address"},{"indexed":true,"name":"contractAddress","type":"address"}],"name":"LogProximityDetectionRequest","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"node","type":"address"},{"indexed":false,"name":"channel","type":"string"},{"indexed":false,"name":"message","type":"string"},{"indexed":false,"name":"duration","type":"uint256"}],"name":"LogBroadcastRequest","type":"event"}],
