module.exports = {
    ...
    // This endpoints ethereum account address
    "animistAccount" : "xyz . . . etc",

    // This peripheral's unique Animist id and human-readable name
    "animistId": "some id here",
    "animistName": "AnimistTesting",
    ...
    "characteristicUUIDS": {
        ...
        "getSubmittedTxHash" : "421522D1-C7EE-494C-A1E4-029BBE644E8D",
        "getContract":  "BFA15C55-ED8F-47B4-BD6A-31280E98C7BA",
        "authTx": "297E3B0A-F353-4531-9D44-3686CC8C4036",
        "authAndSubmitTx": "8D8577B9-E2F0-4750-BB82-421750D9BF86",
        "submitTx" : "3340BC2C-70AE-4E7A-BE24-8B2ED8E3ED06"
    },
    ...
    // The interval during which a given pin authentication is valid
    ...
    // API ABI. These are default animist methods call with the animist account.
    // Like verification.
