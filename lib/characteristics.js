...
const getVerifiedTxStatusCharacteristic = new bleno.Characteristic({
   uuid: config.characteristicUUIDS.getVerifiedTxStatus,
   properties: ['write'], 
   onWriteRequest: handlers.onGetVerifiedTxStatus,
});
...
module.exports = {
    ...
    getVerifiedTxStatusCharacteristic: getVerifiedTxStatusCharacteristic,
