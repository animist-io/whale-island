 ...
 */
const confirmMessageRead = exports.confirmMessageRead = function( args, client){
    ...
    try {
        ...
        clientContract = web3.eth.contract(config.methodsABI);
        instance = clientContract.at(args.contractAddress);
        instance.confirmMessageDelivery( client, args.uuid, now, {from: nodeAccount, gas: 3141592 });
        return true;
