...
/** 
 Recovers address used to sign a msg. Message may be encoded in eth-lightwallet or web3.sign 
...
/**
 * @method  callTx (wraps web3.eth.call)
 * @param { String } method: constant function call
 * @returns { String } value: hex encoded value per web3
 */
...
/** 
 ...
 Returns a contract event object: 
    { code: contract code, 
      account: account addr. specified in the contract event, (should be endpoint caller) 
      authority: account addr. designated to sign transactions for this contract on behalf of caller
...
/**
 ...
 @method authTx
 @returns {Promise} txHash: resolves hash string of pending AuthTx
