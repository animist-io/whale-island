 ...
 * @method onSubmitTx
 * @param {Object} encrypted: Encrypted, signed method call and sessionId `{tx: "0x123d..", sessionId: "9tfh1..v"}`
 * @param {Buffer} callback: initial response is hex code: `0x00` on success or err. 
...
/**
 ...
 @returns {Buffer} JSON formatted null value on error.
*/ 
const onAuthTx = function(encrypted, offset, response, callback){
    ...
    util.decrypt(encrypted).then( data => {
        ...
        self = defs.authTxCharacteristic;
...
/**
 ...
 @returns {Buffer} JSON formatted null value on error.
*/ 
const onAuthAndSendTx = function(encrypted, offset, response, callback ){
