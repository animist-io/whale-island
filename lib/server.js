...
/**
 ...
 @method onGetPin
 @returns {string} 32 character alpha-numeric pin string
*/ 
...
/**
 ...
 @returns {JSON string} int value converted to string.
*/ 
...
/**
 ...
 @returns {JSON object | JSON null string} blockNumber: int OR null, nonce: int, gas: int
*/
...
/**
 ...
 @returns {Number} Initial response is hex code callback. 0x00 on success or hex error code.
 @returns {JSON object | JSON null string} sessionId: string, expires: int, account: address
*/
...
/**
 Responds w/ the transaction hash of the submitted tx in an atomic authAndSubmit 
 request. This is available once the submittedTx has been mined.  
...
// eth-lightwallet signed method call. Gets contract, auths and passes
// signed tx and the auth hash to submitTxWhenAuthed. Responds immediately w
// auth transaction receipt. 
